...
class ManifestInvalidRevisionError(ManifestParseError):
    ...
    def __init__(self, *args, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.MANIFEST_INVALID_REVISION_ERROR)
        super().__init__(*args, **kwargs)
...
class ManifestInvalidPathError(ManifestParseError):
    ...
    def __init__(self, *args, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.MANIFEST_INVALID_PATH_ERROR)
        super().__init__(*args, **kwargs)
...
class NoManifestException(RepoExitError):
    ...
    def __init__(self, path, reason, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.NO_MANIFEST_EXCEPTION)
...
class GitAuthError(RepoExitError):
    ...
    def __init__(self, *args, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.GIT_AUTH_ERROR)
        super().__init__(*args, **kwargs)
...
class DownloadError(RepoExitError):
    ...
    def __init__(self, reason, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.DOWNLOAD_ERROR)
        super().__init__(reason, **kwargs)
        self.reason = reason
...
class InvalidArgumentsError(RepoExitError):
    ...
    def __init__(self, *args, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.INVALID_ARGUMENTS_ERROR)
        super().__init__(*args, **kwargs)
...
class UpdateManifestError(RepoExitError):
    ...
    def __init__(self, *args, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.UPDATE_MANIFEST_ERROR)
        super().__init__(*args, **kwargs)
...
class NoSuchProjectError(RepoExitError):
    ...
    def __init__(self, name=None, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.NO_SUCH_PROJECT_ERROR)
...
class InvalidProjectGroupsError(RepoExitError):
    ...
    def __init__(self, name=None, **kwargs):
        kwargs.setdefault("exit_code", ExitCode.INVALID_PROJECT_GROUPS_ERROR)
        super().__init__(**kwargs)
        self.name = name
