...
class RepoExitError(BaseRepoError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(f"RepoExitCode: {exit_code}", *args, **kwargs)
        self.exit_code = exit_code
        self.aggregate_errors = aggregate_errors


class ManifestParseError(RepoError):
...
class NoManifestException(RepoError):
...
class NoSuchProjectError(RepoError):
...
class InvalidProjectGroupsError(RepoError):
