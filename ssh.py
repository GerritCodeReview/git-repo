...
class ProxyManager:
    ...
    def _open_unlocked(self, host, port=None):
        ...
        git_protocol_version = get_git_protocol_version()
...
def get_git_protocol_version():
    try:
        ...
        if e.returncode == 1:
            # Since git version 2.26, protocol v2 is the default, safe to assume that's the default if unset
            return "2"
        raise
