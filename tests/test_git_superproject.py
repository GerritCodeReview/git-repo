...
""")
    self._superproject = git_superproject.Superproject(manifest)
...
""")
    superproject = git_superproject.Superproject(manifest)
    self.assertFalse(superproject.GetSuperprojectFromManifest())
...
""")
  ...
  def test_superproject_get_superproject_invalid_branch(self):
    ...
    self.assertFalse(self._superproject.GetSuperprojectFromManifest(
        branch='junk'))
  ...
  def test_superproject_get_superproject_mock_fetch(self):
    ...
    with mock.patch.object(self._superproject, '_Clone', return_value=True):
      ...
      with mock.patch.object(self._superproject, '_Fetch', return_value=False):
        self.assertTrue(self._superproject.GetSuperprojectFromManifest())

  def test_superproject_get_all_project_shas_mock_ls_tree(self):
    ...
    with mock.patch.object(self._superproject, '_Clone', return_value=True):
      with mock.patch.object(self._superproject, '_LsTree', return_value=data):
        shas = self._superproject._GetAllProjectsSHAs(branch='junk')
