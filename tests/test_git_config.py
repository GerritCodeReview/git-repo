...
def test_get_int_invalid(readonly_config: git_config.GitConfig) -> None:
    ...
    # The original test called GetBoolean here, but the name says GetInt.
    # unittest code: self.assertIsNone(self.config.GetBoolean("section.intinvalid"))
    assert readonly_config.GetBoolean("section.intinvalid") is None
