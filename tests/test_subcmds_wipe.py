...
class WipeUnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def create_mock_project(name, objdir_path=None):
    ...
    def test_wipe_single_unshared_project(self):
        ...
        p1 = self.create_mock_project("project/one")
    ...
    def test_wipe_multiple_unshared_projects(self):
        ...
        p1 = self.create_mock_project("project/one")
        p2 = self.create_mock_project("project/two")
    ...
    def test_wipe_shared_project_no_force_raises_error(self):
        ...
        p1 = self.create_mock_project("project/one", objdir_path=shared_objdir)
        p2 = self.create_mock_project("project/two", objdir_path=shared_objdir)
