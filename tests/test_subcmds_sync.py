...
class SyncCommand(unittest.TestCase):
    ...
    def _ExecuteUntilSync(self, args):
    ...
    def test_reproject_cmd_allows_a_flat_manifest(self):
    ...
    def test_reproject_cmd_rejects_nested_projects(self):
    ...
    def test_reproject_cmd_rejects_a_submodule(self):
    ...
    def test_reproject_cmd_checks_the_whole_manifest(self):
    ...
    def test_reproject_cmd_off_ignores_nested_projects(self):
