...
class ManifestPropertiesFetchedCorrectly(unittest.TestCase):
    ...
    def test_get_upstream_fallback_metaproject_skips_manifest_load(self) -> None:
    ...
    def test_sharing_project_has_shallow_metaproject_skips_manifest_load(self) -> None:
