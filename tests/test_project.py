...
class ReviewableBranchTests(unittest.TestCase):
    ...
    def test_upload_for_review_forwards_git_event_log(self):
...
class ProjectTests(unittest.TestCase):
    ...
    def test_find_gerrit_urls(self):
    ...
    def _create_project_for_upload_test(self):
        proj = mock.MagicMock(spec=project.Project)
    ...
    def test_upload_for_review_event_emission(self):
    ...
    def test_upload_for_review_event_emission_no_cls(self):
    ...
    def test_upload_for_review_no_event_log(self):
    ...
    def test_upload_for_review_tracing_exception_handled(self):
    ...
    def test_upload_for_review_real_event_log(self):
