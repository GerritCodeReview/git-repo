...
class ProjectTests(unittest.TestCase):
    ...
    def test_resolve_commit_uses_end_of_options_when_supported(self):
    ...
    def test_resolve_commit_rejects_option_on_old_git(self):
    ...
    def test_get_branches_reuses_ref_snapshot_for_current_branch(self):
    ...
    def test_get_branches_reads_worktree_head_for_git_worktrees(self):
    ...
    def test_get_branches_tolerates_unreadable_head(self):
    ...
    def test_prune_heads_reuses_refs_and_avoids_revision_walk(self):
    ...
    def test_prune_heads_compares_peeled_tag_commit(self):
...
def test_metaproject_has_changes_bounds_revision_walk():
