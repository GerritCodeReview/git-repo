...
def _create_manifest_project(tempdir):
...
class ReprojectCmdTests(unittest.TestCase):
    ...
    @staticmethod
    def _git_command(staged="", diff="", returncode=0):
    ...
    def _reproject(self, proj, **outputs):
    ...
    def test_reproject_runs_the_command_with_project_env(self):
    ...
    def test_reproject_rejects_a_staged_change(self):
    ...
    def test_reproject_unborn_head_rejects_a_staged_change(self):
    ...
    def test_reproject_unborn_head_runs_clean(self):
    ...
    def test_reproject_rejects_an_operation_in_progress(self):
    ...
    def test_reproject_surfaces_a_failed_command(self):
    ...
    def test_reproject_rejects_a_moved_head_ref(self):
    ...
    def test_reproject_rejects_a_moved_head_oid_on_branch(self):
    ...
    def test_reproject_rejects_an_index_mismatch(self):
    ...
    def _get_synced_project(
        self, tempdir, head, branch=None, upstream_gain=(), local_changes=()
    ):
    ...
    @staticmethod
    def _tracking_branch(name="topic", merge="main"):
    ...
    def test_sync_local_half_materializes_a_fresh_project(self):
    ...
    def test_sync_local_half_detached_head_uses_the_command(self):
    ...
    def test_sync_local_half_head_at_target_skips_the_command(self):
    ...
    def test_sync_local_half_command_failure_fails_the_project(self):
    ...
    def test_sync_local_half_fast_forward_uses_the_command(self):
    ...
    def test_sync_local_half_head_ahead_skips_the_command(self):
    ...
    def test_sync_local_half_hard_reset_uses_the_command(self):
    ...
    def test_sync_local_half_rebase_is_not_delegated(self):
    ...
    def test_sync_local_half_rejects_a_nested_project(self):
    ...
    def test_sync_local_half_without_the_command_uses_git(self):
    ...
    def test_metaproject_never_uses_the_command(self):
    ...
    def test_sync_reproject_cmd_requires_use_local_gitdirs(self):
...
class ReprojectCmdGitTests(unittest.TestCase):
    ...
    def _make_client(self, topdir, reproject_cmd):
    ...
    def _step_back(self, proj, revid):
    ...
    def test_sync_local_half_checks_out_a_fresh_project(self):
    ...
    def test_sync_local_half_keeps_local_changes_out_of_the_way(self):
    ...
    def test_sync_local_half_rejects_a_local_change_in_the_way(self):
    ...
    def test_sync_local_half_rejects_a_command_that_moves_head(self):
    ...
    def test_sync_local_half_rejects_staged_changes(self):
        """Test a staged change fails before the command runs."""
        with tempfile.TemporaryDirectory(prefix="repo-tests") as topdir:
            proj, revid = self._make_client(topdir, self.READ_TREE)
            worktree = proj.worktree
    ...
    def test_sync_local_half_rejects_a_command_that_moves_branch_tip(self):
    ...
    def test_sync_local_half_keeps_local_changes_on_tracking_branch(self):
