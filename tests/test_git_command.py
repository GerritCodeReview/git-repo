...
class SSHUnitTest(unittest.TestCase):
  ...
  def test_ssh_version(self):
    ...
    ver = git_command._parse_ssh_version(b'Unknown\n')
    self.assertEqual(ver, ())
    ver = git_command._parse_ssh_version(b'OpenSSH_1.0\n')
    self.assertEqual(ver, (1, 0))
    ver = git_command._parse_ssh_version(b'OpenSSH_6.6.1p1 Ubuntu-2ubuntu2.13, OpenSSL 1.0.1f 6 Jan 2014\n')
    self.assertEqual(ver, (6, 6, 1))
    ver = git_command._parse_ssh_version(b'OpenSSH_7.6p1 Ubuntu-4ubuntu0.3, OpenSSL 1.0.2n  7 Dec 2017\n')
