...
class GcCommand(unittest.TestCase):
    ...
    def test_execute_no_args(self):
        """Test Execute without specific projects."""
    ...
    def test_execute_with_args(self):
        """Test Execute with specific projects uses all_projects for delete."""
    ...
    def test_exit_on_delete_failure(self):
        """Test Execute exits if delete_unused_projects fails."""
        self.mock_get_projects.return_value = ["all"]
