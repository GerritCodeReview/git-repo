...
class RemoteAbsoluteUrlTests(ManifestParseTestCase):
    ...
    def test_is_absolute(self):
        manifest = self.getXmlManifest(
            """
<manifest>
  <remote name="default" fetch="http://localhost" is-absolute-fetch-url="true"/>
</manifest>
"""
        )

        self.assertEqual(
            "http://localhost", manifest.remotes["default"].fetchUrl
        )
    ...
    def test_is_not_absoluate(self):
        manifest = self.getXmlManifest(
            """
<manifest>
  <remote name="default" fetch="http://localhost" />
</manifest>
"""
        )
