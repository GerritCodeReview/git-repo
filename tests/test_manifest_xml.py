...
""")
    self.assertEqual(manifest.superproject_xml['name'], 'superproject')
    self.assertEqual(manifest.superproject_xml['remote'].name, 'test-remote')
    self.assertEqual(
...
""")
    self.assertEqual(manifest.superproject_xml['name'], 'superproject')
    self.assertEqual(manifest.superproject_xml['remote'].name, 'test-remote')
    self.assertEqual(manifest.superproject_xml['remote'].url, 'http://localhost/superproject')
    self.assertEqual(manifest.superproject_xml['revision'], 'refs/heads/main')
    self.assertEqual(
        sort_attributes(manifest.ToXml().toxml()),
        '<?xml version="1.0" ?><manifest>'
        '<remote fetch="http://localhost" name="test-remote"/>'
...
""")
    ...
    self.assertEqual(manifest.superproject_xml['remote'].name, 'test-remote')
    self.assertEqual(manifest.superproject_xml['remote'].url, 'http://localhost/superproject')
    self.assertEqual(manifest.superproject_xml['revision'], 'refs/heads/stable')
    self.assertEqual(
        sort_attributes(manifest.ToXml().toxml()),
        '<?xml version="1.0" ?><manifest>'
        '<remote fetch="http://localhost" name="test-remote"/>'
...
""")
    self.assertEqual(manifest.superproject_xml['name'], 'platform/superproject')
    self.assertEqual(manifest.superproject_xml['remote'].name, 'superproject-remote')
    self.assertEqual(manifest.superproject_xml['remote'].url, 'http://localhost/platform/superproject')
    self.assertEqual(manifest.superproject_xml['revision'], 'refs/heads/main')
    self.assertEqual(
        sort_attributes(manifest.ToXml().toxml()),
        '<?xml version="1.0" ?><manifest>'
...
""")
    self.assertEqual(manifest.superproject_xml['name'], 'superproject')
    self.assertEqual(manifest.superproject_xml['remote'].name, 'default-remote')
    self.assertEqual(manifest.superproject_xml['revision'], 'refs/heads/main')
    self.assertEqual(
        sort_attributes(manifest.ToXml().toxml()),
        '<?xml version="1.0" ?><manifest>'
