...
class RepoClient:
    ...
    def __init__(self, topdir: Path):
        self.repo_client_checkout = utils_for_test.RepoClientCheckout(topdir)
        self.topdir = self.repo_client_checkout.topdir
        self.repodir = self.repo_client_checkout.repodir
        self.manifest_dir = self.repo_client_checkout.manifest_dir
        self.manifest_file = self.repo_client_checkout.manifest_file
        self.local_manifest_dir = self.repo_client_checkout.local_manifest_dir
        # The manifest parsing really wants a git repo currently.
        self.repo_client_checkout.init_manifest_git()

    def get_xml_manifest(self, data: str) -> manifest_xml.XmlManifest:
        """Helper to initialize a manifest for testing."""
        self.repo_client_checkout.write_manifest(data)
        return self.repo_client_checkout.xml_manifest()
