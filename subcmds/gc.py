...
"""
    ...
    def Execute(self, opt, args):
        ...
        to_delete = self._find_git_to_delete(
            project_paths,
            os.path.join(self.repodir, "projects"))

        to_delete.update(self._find_git_to_delete(
        ...
        print("\n".join(to_delete))
        print("\n")
        print("If you proceed, any local commits in those projects will be "
              "destroyed!")
