...
"""
        ...
        for m in self.ManifestList(opt):
            ...
            if use_super and (m.IsMirror or m.IsArchive):
                ...
                if opt.use_superproject is not False:
                    print(
                        f"{m.path_prefix}: not using superproject because there is no "
                        "working tree."
                    )
        ...
        if expected != actual:
            ...
            if expected:
                ...
                if git_require((2, 7, 0)):
                    ...
                    print(
                        "\r%s: WARNING: shared projects are unreliable when using "
    ...
    def ValidateOptions(self, opt, args):
        if opt.force_broken:
            print(
                "warning: -f/--force-broken is now the default behavior, and the "
