...
"""
  ...
  def _UpdateProjectsRevisionId(self, opt, args, load_local_manifests, superproject_logging_data, manifest):
    ...
    """
    print_messages = git_superproject.PrintMessages(opt, manifest)
    superproject = manifest.superproject
    if opt.local_only:
  ...
  def Execute(self, opt, args):
    ...
    superproject_logging_data = {
        ...
        'hassuperprojecttag': bool(manifest.superproject_xml),
    }
    if use_superproject:
      manifest_name = self._UpdateProjectsRevisionId(
          opt, args, load_local_manifests, superproject_logging_data, manifest) or opt.manifest_name
