...
much as possible of the data in the ref-directory when fetching 
...
"""
  ...
  def _Options(self, p, show_smart=True):
    ...
    p.add_option('--ref-dir',
		 dest='ref_dir', action='store',
		 help="location of mirror directory")
    if show_smart:
