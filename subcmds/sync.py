...
"""
    ...
    def _ResolveManifestServerTransport(self, opt, manifest):
        ...
        Returns:
            Tuple[str, xmlrpc.client.Transport]: The resolved server URL and transport.

        Raises:
            SmartSyncError: If resolution fails (e.g. helper missing, helper error, unsupported scheme).
        """
        ...
        if helper_binary:
            ...
            try:
                ...
                raise SmartSyncError(
                    f"helper {helper_binary} timed out after 10 seconds"
                ) from e
            except Exception as e:
                raise SmartSyncError(
    ...
    def _SmartSyncSetup(self, opt, smart_sync_manifest_path, manifest):
        ...
        server_url, transport = self._ResolveManifestServerTransport(opt, manifest)
