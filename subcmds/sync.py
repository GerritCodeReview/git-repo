...
"""
  ...
  def _FetchOne(self, opt, project):
    ...
    finish = time.time()
    return _FetchOneResult(success, project, start, finish, remote_fetched, newly_created)
  ...
  def _Fetch(self, projects, opt, err_event, ssh_proxy):
    ...
    return _FetchResult(ret, fetched, updated_from_remote)
  ...
  def _FetchMain(self, opt, args, all_projects, err_event,
    ...
    if opt.network_only:
      ...
      if err_event.is_set():
        ...
        sys.exit(1)
      return _FetchMainResult([], updated_from_remote)
    ...
    return _FetchMainResult(all_projects, updated_from_remote)
