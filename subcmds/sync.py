...
index or the working tree differs from HEAD, and if there are untraced files.
...
"""
    ...
    def _CheckoutOne(
        self, detach_head, force_sync, force_remove_dirty, verbose, project
    ):
