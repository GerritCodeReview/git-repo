...
"""
  ...
  def _Options(self, p, show_smart=True):
    ...
    p.add_option('--keep-manifest',
                 dest='keep_manifest', action='store_true',
                 help="update from server, but with no manifest update, "
                      "meaning keep local version as is")
  ...
  def Execute(self, opt, args):
    ...
    if opt.keep_manifest:
      print('Keeping local manifest project.')
    else:
