...
def _RefreshDerivedRevisions(
    ...
    submodule_revisions: Optional[Dict[str, Dict[str, str]]] = None,
) -> None:
    ...
    Args:
        ...
        submodule_revisions: Gitlinks already read, keyed by the path of the
            project holding them. Passing the same dict for project sets that
            follow the same fetches, e.g. the levels of one checkout order,
            keeps a project from being read more than once.
    """
