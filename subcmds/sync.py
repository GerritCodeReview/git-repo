...
The --force-dirty option can be used to remove previosly used project
with uncommitted changes. WARNING: This may cause data to be lost since
uncommitted changes may be removed with project that no longer exist
in the manifest.
...
"""
  ...
  def _Options(self, p, show_smart=True):
    ...
    p.add_option('--force-dirty',
                 dest='force_dirty', action='store_true',
                 help="force remove project with uncommitted modifications if "
                      "project no longer exist in the manifest. "
