...
will read the user's .netrc file, if one exists, and attempt to find
authentication credentials for the manifest server.  If any are found,
'%prog%' will use them to authenticate with the manifest server.
