...
"""
  ...
  def Execute(self, opt, args):
    all_projects = self.GetProjects(args, all_manifests=not opt.this_tree_only)
    ...
    if opt.orphans:
      ...
      for project in self.GetProjects(None, missing_ok=True, all_manifests=not opt.this_tree_only):
