...
class BaseEventLog:
    ...
    def RegionEnterEvent(self, category, label, nesting=1, msg=None):
    ...
    def RegionLeaveEvent(
        self, category, label, nesting=1, t_rel=None, msg=None
    ):
    ...
    def RecordRegion(self, category, label, nesting=1, msg=None):
