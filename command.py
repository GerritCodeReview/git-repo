...
class Command(object):
    ...
    def ExecuteInParallel(
        ...
        Args:
          ...
          callback: The function to pass the results to for processing. It will
              be executed in the main thread and process the results of |func|
              as they become available. Thus it may be a local nested function.
              Its return value is passed back directly. It takes three
              arguments:
    ...
    def GetProjects(
        ...
        Args:
          ...
          all_manifests: a boolean, if True then all manifests and submanifests
                         are used. If False, then only the local (sub)manifest
                         is used.
