...
class Project:
    ...
    def _createDotGit(self, dotgit):
        """For submodule projects, create '.git' using the gitfile mechanism
        and for the rest, create a symb link.
        """
    ...
    def _removeBadGitDirLink(self, dotgit):
        """Check if .git points to a valid bare checkout dir. If not, remove
        it.
        """
