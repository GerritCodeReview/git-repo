...
class Project:
    ...
    def _CheckForImmutableRevision(
        ...
        try:
            ...
            # Check upstream when using superproject or for non-shallow clones
            # with upstream.
            if verify_upstream:
            ...
            # Verify upstream relationship for superproject scenarios or
            # non-shallow clones.
            if verify_upstream:
    ...
    def _IsShallow(self, depth: Optional[int] = None) -> bool:
        ...
        return bool(
            self._HasShallow()
            or self._SharingProjectHasShallow()
            or depth
        )
