...
class Project(object):
  def __init__(self,
    ...
    A project can only be either one of the three states:
      * (non-sub) project
          parent is None     and not is_derived
      * registered subproject
          parent is not None and not is_derived
      * derived subproject
          parent is not None and is_derived
    ...
    Args:
      ...
      is_derived: True if it is a derived subproject.
    """
  ...
  def _GetSubmodules(self):
    ...
    def parse_gitmodules(gitdir, rev):
      ...
      for line in p.stdout.split('\n'):
        # Because "path = ..." and "url = ..." appear after each other, it has
        # paths[i] and urls[i] belonging to the same submodule
