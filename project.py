...
# Sync ##
  ...
  def Sync_NetworkHalf(self,
    ...
    self.CheckReachable(syncbuf, ignore_bad_refs, is_new, bad_refs,
                        remote_fetched)
  ...
  def CheckReachable(self, syncbuf, ignore_errors, is_new, bad_refs,
                     remote_fetched):
    ...
    Args:
      ...
      bad_refs (str): 'default' for default, 'no' for no checks,
                      'opt' for 'quick' checks, 'all' for all checks.
    ...
    if bad_refs == "default" or not bad_refs:
      bad_refs = 'no'
