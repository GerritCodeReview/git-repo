...
## Sync ##
  ...
  def _ExtractArchive(self, tarpath, path=None):
    ...
    try:
      ...
      print("error: file not found %s." % tarpath, file=sys.stderr)
    except tarfile.TarError:
      print("error: Cannot extract archive %s." % tarpath, file=sys.stderr)
    return False
  ...
  def Sync_NetworkHalf(self,
    ...
    if archive and not isinstance(self, MetaProject):
      ...
      command = GitCommand(self, cmd, cwd=topdir,
                           capture_stdout=True,
                           capture_stderr=True)
      ...
      try:
        ...
        print("warn: Cannot remove archive %s." % tarpath, file=sys.stderr)
      self._CopyFiles()
      return True
