        ...
        try:
            ...
            if init_git_dir:
                ...
                def _expanded_ref_dirs():
                    """Iterate through the possible git reference directory
                    paths."""
                    name = self.name + ".git"
...
class ManifestProject(MetaProject):
    ...
    def Sync(
        ...
        Args:
          ...
          use_superproject: a boolean, whether to use the manifest superproject
              to sync projects.
          verbose: a boolean, whether to show all output, rather than only
              errors.
          current_branch_only: a boolean, whether to only fetch the current
          ...
          this_manifest_only: a boolean, whether to only operate on the current
              sub manifest.
