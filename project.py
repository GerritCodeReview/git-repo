...
class Project:
    ...
    def _CheckForImmutableRevision(
        ...
        try:
            ...
            upstream_rev = None
            use_superproject_for_upstream = self._UseSuperprojectForUpstream(
                use_superproject
            )

            # Only check upstream when using superproject.
            if self.upstream and use_superproject_for_upstream:
    ...
    def _UseSuperprojectForUpstream(
        ...
        """
        return git_superproject.UseSuperproject(
