...
class _CopyFile(NamedTuple):
    ...
    Attributes:
      git_worktree (str): Absolute path to the git project checkout.
      src (str): Relative path under |git_worktree| of file to read.
      topdir (str): Absolute path to the top of the repo client checkout.
      dest (str): Relative path under |topdir| of file to write.
    """
...
class _LinkFile(NamedTuple):
    ...
    Attributes:
      git_worktree (str): Absolute path to the git project checkout.
      src (str): Target of symlink relative to path under |git_worktree|.
      topdir (str): Absolute path to the top of the repo client checkout.
      dest (str): Relative path under |topdir| of symlink to create.
    """
