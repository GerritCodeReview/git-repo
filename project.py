  ...
  def _RemoteFetch(self, name=None,
    ...
    for _i in range(2):
      ...
      # If needed, run the 'git remote prune' the first time through the loop
            ...
            "error: some local refs could not be updated; try running" in gitcmd.stderr and
            "'git remote prune {}' to remove any old, conflicting".format(name) in gitcmd.stderr):
