...
class MetaProject(Project):
    ...
    def __init__(self, manifest, name, gitdir, worktree):
        ...
        # _DefaultBranchFallback() needs self.bare_git, which
        # Project.__init__ sets up, so we can't pass it as revisionExpr
        # above; apply it once init is done.
        self.SetRevision(self._DefaultBranchFallback())

    def _DefaultBranchFallback(self) -> str:
