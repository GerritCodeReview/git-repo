            ...
            if branch_obj.LocalMerge:
                try:
                    left_right = self.work_git.rev_list(
                        ...
                        "%s...%s"
                        % (
                            branch_obj.LocalMerge,
                            R_HEADS + branch_obj.name,
                        ),
                    )
                    ...
                    ahead = int(right)
                    if ahead and behind:
                        ahead_behind = " [ahead %d, behind %d]" % (
                            ahead,
                            behind,
                        )
                    elif ahead:
                        ahead_behind = " [ahead %d]" % ahead
                    elif behind:
                        ahead_behind = " [behind %d]" % behind
                except GitError:
                    pass
