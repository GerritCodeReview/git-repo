...
class Project:
    ...
    def UncommitedFiles(self, get_all=True):
        ...
        if status is not None:
            return self._UncommitedFilesFromStatus(status, get_all=get_all)

        return self._UncommitedFilesLegacy(get_all=get_all)

    def _UncommitedFilesFromStatus(
    ...
    def _UncommitedFilesLegacy(self, get_all: bool = True) -> List[str]:
