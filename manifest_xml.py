...
class XmlManifest(object):
  ...
  def _CheckLocalPath(path, symlink=False):
    ...
    # exclusively because some platforms (like Windows) will convert / to \ and
    # that bypasses all our constructed logic here.  Especially since manifest
    # authors will normally only use / in their paths.
