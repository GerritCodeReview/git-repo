...
class Superproject(object):
  ...
  def UpdateProjectsRevisionId(self, projects):
    ...
    for project in projects:
      ...
      if not path:
        continue
      # Some manifests that pull projects from the "chromium" GoB (remote="chromium"),
      # and have a private manifest that pulls projects from both the chromium GoB and
      # "chrome-internal" GoB (remote="chrome"). For such projects, one of the remotes
      # will be different from superproject's remote. Until superproject, supports
      # multiple remotes, don't update the commit ids of remotes that don't match
      # superproject's remotes.
