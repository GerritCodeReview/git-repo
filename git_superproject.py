...
"""Provide functionality to get all projects and their commit ids from
Superproject.
...
class Superproject(object):
    ...
    def _Fetch(self):
        """Fetches a local copy of a superproject for the manifest based on
        |_remote_url|.
    ...
    def _GetAllProjectsCommitIds(self):
        """Get commit ids for all projects from superproject and save them in
        _project_commit_ids.
