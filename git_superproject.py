...
class UpdateProjectsResult(NamedTuple):
  ...
  # Path name of the overriding manfiest file if successful
  manifest_path: str
  # Whether the caller should exit.
  fatal: bool
...
class Superproject(object):
  ...
  def __init__(self, manifest, repodir, git_trace2_event_log,
    ...
    Args:
      ...
      git_trace2_event_log: A git trace2 event log to log events.
  ...
  def Sync(self):
    ...
    Returns:
      SyncResult a NamedTuple of (if sync of superproject is successful, or False,
  ...
  def _GetAllProjectsCommitIds(self):
    ...
    Returns:
      CommitIdsResult a NamedTuple of (a dictionary with the projects/commit ids on success,
          otherwise None, True if caller should exit, Or False).
    """
  ...
  def UpdateProjectsRevisionId(self, projects):
    ...
    Returns:
      UpdateProjectsResult a NamedTuple (overriding manfiest file instead of None,
          True if caller should exit, Or False).
    """
