...
https://gerrit.googlesource.com/git-repo/+/HEAD/docs/manifest-format.md#Element-superproject
...
class Superproject(object):
  """Get SHAs from superproject. It does a 'git clone' of superproject and 'git ls-tree'
  to get list of SHAs for all projects.
  ...
  def GetAllProjectsSHAs(self, url, branch=None):
    ...
    # build a dictionary with project path (last element) and it's SHA (2nd element).
    #
    # 160000 commit 40d4bc9e199d93dd62615d512b24ec5d5d600075    bootable/recovery
    # 120000 blob 0a467554a6de18d858e55db58697c1efebc73de0      build/CleanSpec.mk
    shas = {}
