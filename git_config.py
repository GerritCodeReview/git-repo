...
class GitConfig:
    ...
    def _do(self, *args):
        ...
        if p.Wait() == 0:
            ...
            raise GitError("git config {}: {}".format(str(args), p.stderr))
...
class Remote:
        ...
        if self._review_url is None:
            ...
            if u in REVIEW_CACHE:
                ...
                try:
                    ...
                    raise UploadError("{}: {}".format(self.review, str(e)))
                except urllib.error.URLError as e:
                    raise UploadError("{}: {}".format(self.review, str(e)))
                except http.client.HTTPException as e:
                    raise UploadError(
                        "{}: {}".format(self.review, e.__class__.__name__)
                    )
    ...
    def _SshReviewUrl(self, userEmail, host, port):
        ...
        return "ssh://{}@{}:{}/".format(username, host, port)
    ...
    def _Set(self, key, value):
        key = "remote.{}.{}".format(self.name, key)
...
class Branch:
    ...
    def _Set(self, key, value):
        key = "branch.{}.{}".format(self.name, key)
        return self._config.SetString(key, value)
