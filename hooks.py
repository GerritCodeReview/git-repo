...
class RepoHook:
    ...
    def _CheckForHookApprovalHelper(
        ...
        git_approval_key = "repo.hooks.{}.{}".format(self._hook_type, subkey)
    ...
    def _CheckForHookApprovalManifest(self):
        ...
        return self._CheckForHookApprovalHelper(
            "approvedmanifest",
            self._manifest_url,
            "Run hook scripts from {}".format(self._manifest_url),
...
""".format(
        ...
        if proc.returncode:
            raise HookError("Failed to run {} hook.".format(self._hook_type))
