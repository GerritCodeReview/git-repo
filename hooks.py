  ...
  def __init__(self,
    ...
    Params:
      hook_type: A string representing the type of hook.  This is also used
          ...
          example: 'pre-upload'.
      bypass_hooks: cmdline argument for 'Do not run the hook'.
      allow_all_hooks: cmdline argument for 'Run the hook without prompting'.
      ignore_hooks: cmdline argument for 'Do not abort action if hooks fail'.
      hooks_project: The project containing the repo hooks.
      repo_topdir: Repo's top directory
...
""" % {
  ...
  def AddOptionGroup(parser, name):
    ...
    group.add_option('--ignore-hooks',
                 action='store_true',
                 help='Do not abort action if %s hooks fail.' % name)
