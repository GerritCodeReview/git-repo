...
|   Date   |     EOL      | [Git][rel-g] | [Python][rel-p] | [OpenSSH][rel-o] | [Ubuntu][rel-u] / [Debian][rel-d] | Git | Python | OpenSSH |
|:--------:|:------------:|--------------|-----------------|------------------|-----------------------------------|-----|--------|---------|
| Apr 2008 |              |              |                 | 5.0              |
| Jun 2008 |              |              |                 | 5.1              |
...
| **Date** |   **EOL**    | **[Git][rel-g]** | **[Python][rel-p]** | **[Ubuntu][rel-u] / [Debian][rel-d]** | **Git** | **Python** | **OpenSSH** |
