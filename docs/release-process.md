...
If something goes wrong, staff/oncall need to be active in order to respond
quickly & effectively.
We also don't want to disrupt external organizations if possible.

We generally follow the rules:

* Release during Mon - Thu, 9:00 - 14:00 [US PT] (i.e. "MTV time")
* Avoid holidays
